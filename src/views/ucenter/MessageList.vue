          ...
          <template #default="{ data }">
            ...
            <div class="message-item" v-if="data.messageType == 0">
              <div class="message-content">
                <span>                                                                                                                                                                                 
                    <h2>欢迎来到HaoRanbbs！</h2>
                    <p>在这里，我们一起分享、学习和成长。无论您是新朋友还是老朋友，我们都希望您在这里找到归属感并留下美好的回忆。</p>
                    <p>您可以在这里结识志同道合的朋友，分享您的见解和经验，也可以从他人的故事中获得启发和帮助。</p>
                    <p>每一个参与者都是这个社区的重要组成部分，您的参与将让这里变得更加丰富多彩。</p>
                    <p>让我们携手共建一个温馨、包容、充满活力的社区，共同书写精彩的故事！</p>
                    <p>欢迎您的加入，让我们一起创造美好的社区未来！</p>
                </span>
